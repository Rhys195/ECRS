...
def index():
    ...
    trending_products = clean_data.sort_values(by=['Rating', 'ReviewCount'], ascending=False).head(30)
    ...
    trending_products_list = trending_products.to_dict(orient='records')
    ...
    return render_template(
        ...
        cart_count=cart_count,truncate=truncate
    )
